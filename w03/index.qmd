...
var chartMutex = venn.VennDiagram().width(500);
// draw venn diagram
var div = d3.select("#venn");
var divMutex = d3.select("#vennMutex");
div.datum(sets).call(chart);
divMutex.datum(setsMutex).call(chartMutex);
...
![This photo, originally thought to be of Thomas Bayes, turns out to be [probably someone else](https://www.york.ac.uk/depts/maths/histstat/bayespic.htm)... $P(\textsf{Bayes})$?](images/bayes.jpg){fig-align="center" width="65%"}
...
* Bo doesn't have it, and neither does anyone else who tested positive!
