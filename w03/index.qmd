...
$$
\begin{align*}
\Pr(\textsf{T}^- \cap \textsf{Sick}) &= \Pr(\textsf{T}^-)\Pr(\textsf{Sick}) \\
&= \Pr(\textsf{T}^-)\frac{1}{10000}, \\
\Pr(\textsf{T}^-) &= (0.01)\left(\frac{1}{10000}\right) \\
&+ (0.99)\left(\frac{9999}{10000}\right) \\
&= 0.989902 \\
\implies \Pr(\textsf{T}^- \cap \textsf{Sick}) &\approx 0.0001
\end{align*}
$$
