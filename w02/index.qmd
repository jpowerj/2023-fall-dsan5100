...
## Example: The Normal Distribution {.smaller}
...
* The parameters in this case give **natural summaries** of the data:
  * ${\color{\purple}\mu}$ = center (mean), ${\color{purple}\sigma}$ = variance around center
* **Mean** can usually be interpreted intuitively; for the **standard deviation**, however, we usually need to use the [**68-95-99.7 rule**](https://en.wikipedia.org/wiki/68%E2%80%9395%E2%80%9399.7_rule){target="_blank"}... But first, let's look at some real-world data
...
## Real Data and the 68-95-99.7 Rule {.smaller .crunch-layout-panel .crunch-title .crunch-figures .crunch-lists}
...
::: {#fig-empirical}
<img src="images/empirical_rule.svg" height="345">
...
* The **point estimate** $\mu = 186.48$ is straightforward: *the average height of the athletes is 186.48cm*. But how do we interpret the **standard deviation**, $\sigma = 9.7$?
* Using the **68-95-99.7 Rule**: *About 68% of the heights fall between*

| | | |
|:-:|:-:|:-:|
| [186.48 - 9.7 | and | 186.48 + 9.7] |
| [176.78 | and | 196.18] |
