...
|:- |:- |:- |:- |:-:|
| **Lecture** | 12:30pm | 12:40pm | <a href="#statistical-inference">Statistical Inference Overview &rarr;</a> | <a href="../recordings/recording-w09-1.html" target="_blank" class="disabled"><i class="bi bi-film"></i></a> |
| | 12:40pm | 1:10pm | <a href="#asymptotic-laws-for-random-samples">Asymptotic Laws for Random Samples &rarr;</a> | <a href="../recordings/recording-w09-2.html" target="_blank" class="disabled"><i class="bi bi-film"></i></a> |
...
[^golem]: A big rock boi from the Talmud (and Pokémon) who follows orders but has no common sense/nuance (like a computer). See @collins_golem_1993 and @mcelreath_statistical_2020
...
## Computing $\expect{\sigma^2_*}$ {.smaller .crunch-title}
...
::: {.callout-note appearance="minimal"}
::: {.quote-text style="display: block; width: 100% !important;"}
*And yet, Machine Learning gets us rly close to free lunches!*
